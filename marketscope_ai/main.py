...
#                         if isinstance(fin_df, dict):  # convert dict to DataFrame if needed
#                             import pandas as pd
...
#                         if isinstance(eps_df, dict):  # convert dict to DataFrame if needed
#                             import pandas as pd
...
#     st.sidebar.markdown("---")
#     symbol = st.sidebar.text_input("Enter Ticker Symbol", "AAPL")
#     currency = st.sidebar.selectbox(
#         "Choose Currency", ["USD", "INR", "EUR", "GBP", "AED", "RUB"]
#     )
#     start_date = st.sidebar.date_input("From Date", datetime.date(2023, 1, 1))
...
#         if symbol:
#             stock_info = get_stock_info(symbol, target_currency=currency)
...
#                     st.warning("No historical data available for this stock.")
#         else:
#             st.info("Please enter a symbol in the sidebar.")
...
#         st.header("📰 News & Sentiment")
#         st.info("🔧 Coming soon: live financial news + sentiment analysis")

#     # ============================
#     # TAB 4: LLM Summary
#     # ============================
#     elif choice == "🧠 LLM Summary":
#         st.header("🧠 LLM Summary")
#         st.info("🤖 AI-generated company summaries will appear here.")
